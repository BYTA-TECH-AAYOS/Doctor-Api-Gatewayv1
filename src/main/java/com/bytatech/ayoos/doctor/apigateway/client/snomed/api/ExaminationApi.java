...
@Api(value = "ExaminationResponse", description = "the DiseaseResponse API")
public interface ExaminationApi {
	@ApiResponses(value = { 
	 ...
	 ResponseEntity<List<SearchResponse>> getExaminationResponse(@ApiParam(value = "term",required=true) @RequestParam("term") String term,
			 @ApiParam(value = "state",required=true ) @RequestParam("state") String state,
			 @ApiParam(value = "semantictag",required=true ) @RequestParam("semantictag") String semantictag,
