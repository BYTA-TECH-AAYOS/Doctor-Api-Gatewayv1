...
@Api(value = "DiseaseResponse", description = "the DiseaseResponse API")
public interface DiseaseApi {
	@ApiResponses(value = { 
	 ...
	 ResponseEntity<List<SearchResponse>> getDiseaseResponse(@ApiParam(value = "term",required=true) @RequestParam("term") String term,
