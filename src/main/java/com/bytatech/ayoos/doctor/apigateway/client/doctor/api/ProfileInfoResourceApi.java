...
import com.bytatech.ayoos.doctor.apigateway.client.doctor.model.ProfileInfoVM;
...
public interface ProfileInfoResourceApi {
    ...
    @ApiOperation(value = "getActiveProfiles", nickname = "getActiveProfilesUsingGET", notes = "", response = ProfileInfoVM.class, tags={ "profile-info-resource", })
    @ApiResponses(value = { 
