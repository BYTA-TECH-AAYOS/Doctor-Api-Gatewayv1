...
import com.bytatech.ayoos.doctor.apigateway.client.doctor.model.User;
...
public interface AccountResourceApi {
    ...
    @ApiOperation(value = "getAccount", nickname = "getAccountUsingGET", notes = "", response = User.class, tags={ "account-resource", })
    @ApiResponses(value = { 
