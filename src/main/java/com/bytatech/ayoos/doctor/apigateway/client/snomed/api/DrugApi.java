...
@Api(value = "DrugResponse", description = "the DrugResponse API")
public interface DrugApi {
	...
	@ApiResponses(value = { 
	 ...
	 ResponseEntity<List<SearchResponse>> getDrugResponse(@ApiParam(value = "term",required=true) @RequestParam("term") String term,
